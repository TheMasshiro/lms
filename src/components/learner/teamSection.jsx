    ...
    <div className="pb-20 px-6 md:px-0 text-center bg-white">
      <section className="bg-gradient-to-b from-white to-gray-50 py-20 px-6 md:px-12 text-center rounded-xl shadow-sm">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Learnify is an interactive e-learning platform designed for aspiring
          developers and tech enthusiasts. We combine bite-sized lessons with
          real-time coding challenges to make learning fun and effective.
        </p>
        ...
        <div className="max-w-4xl mx-auto text-left">
          <h3 className="text-3xl font-semibold text-cyan-600 mb-2">
            Our Mission
          </h3>
          <p className="text-gray-700 mb-6">
            To provide accessible, hands-on learning that helps you build
            real-world coding skills and become confident in your tech journey.
          </p>

          {/* Core Values */}
          <h3 className="text-3xl font-semibold text-cyan-600 mb-4">
            Core Values
          </h3>
          <ul className="space-y-4 text-gray-700 list-disc list-inside">
            <li>
              <strong>Accessibility:</strong> Everyone deserves to learn,
              regardless of background.
            </li>
            <li>
              <strong>Practice-Based:</strong> We believe in learning by doing,
              not just watching.
            </li>
            <li>
              <strong>Community:</strong> We grow better when we grow together.
            </li>
            <li>
              <strong>Progress:</strong> We focus on continuous learning and
              improvement.
            </li>
          </ul>
        </div>
        ...
        {/* How It Works */}
        <div className="mt-16">
          <h3 className="text-3xl font-semibold text-cyan-600 mb-6">
            How It Works
          </h3>
      ...
      <section className="mt-24 text-center bg-gray-50 py-20 px-6 md:px-12 rounded-xl shadow-inner">
        ...
        <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
          Get to know the passionate people behind Learnify — dedicated to
