        ...
        <div className="flex flex-col items-center md:items-start w-full">
          ...
          <ul className="text-sm text-gray-600 space-y-3">
            <li className="flex items-center space-x-3">
              <FaMapMarkerAlt className="text-black text-sm leading-[1.5rem]" />
              <span>01 Upper Kalaklan, Olongapo City</span>
            </li>
            <li className="flex items-center space-x-2">
              <FaPhone className="text-black text-sm leading-[1.5rem]" />
              <a href="tel:+639955068344" className="hover:text-black">
                +639955068344
              </a>
            </li>
            <li className="flex items-center space-x-3">
              <FaEnvelope className="text-black text-sm leading-[1.5rem]" />
              <a
