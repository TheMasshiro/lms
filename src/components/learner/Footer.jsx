    ...
    <footer className="bg-gradient-to-t from-cyan-200/70 to-white-100 py-4 md:px-36 text-left w-full mt-10">
      <div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30">
        ...
        <div className="flex flex-col items-center md:items-start w-full">
          ...
          <ul className="text-sm text-gray-600 space-y-3">
            <li className="flex items-center space-x-3">
              <FontAwesomeIcon icon={faMapMarkerAlt} className="text-black text-sm leading-[1.5rem]" />
              <span>01 Upper Kalaklan, Olongapo City</span>
            </li>
            <li className="flex items-center space-x-2">
              <FontAwesomeIcon icon={faPhoneAlt} className="text-black text-sm leading-[1.5rem]" />
              <a href="tel:+639955068344" className="hover:text-black">+639955068344</a>
            </li>
            <li className="flex items-center space-x-3">
              <FontAwesomeIcon icon={faEnvelope} className="text-black text-sm leading-[1.5rem]" />
              <a href="mailto:learnify2025@gmail.com" className="hover:text-black">learnify2025@gmail.com</a>
           </li>
         </ul>
        </div>
        ...
        <div className="hidden md:flex flex-col w-full">
          <h2 className="font-semibold text-black mb-4">Keep yourself updated</h2>
